class OnlineGameover extends Phaser.Scene{
    ...
    create()
    {
        ...
        this._buttonPlayAgain = new Button(this, viewport.width/2, 230 + viewport.height/2, 0.7, false, "btn_replay", ()=>this.restartGame());
    ...
    restartGame()
    {
        ...
        this.scene.restart("OnlineGameplayScene"); // reinicia la escena del juego
    ...
    {   
        ...
        this.scene.sleep("OnlineGameoverScene");
    ...
    seeStats(){
        ...
        this.scene.start("OnlineStatsScene", { J1stats: this._J1Stats, J2stats: this._J2Stats  }); 
