class TestScene extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        // Menu de pausa para juego local (o para pausa activa online)
        this.load.image('pause_local', '../Assets/UI/Pause Menus/Pause Base.png');

        // Pantalla de pausa cuando el otro jugador activa la pausa en juego online
        this.load.image('pause_wait_online', '../Assets/UI/Pause Menus/Pause Wait.png');
    }
    ...
    processInput()
    {
        ...
        //pause
        if(this.playersInput.pauseKey.isUp) console.log("pausa");
    }
